...
/// <summary>
/// A custom handler that implements the ITrackableEventHandler interface.//Это пользовательский обработчик который реализует интерфейс для обработки отслеживаемых изменений состояния
///
